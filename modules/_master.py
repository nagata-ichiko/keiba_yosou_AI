...
class Master:
    PLACE_DICT: MappingProxyType = dataclasses.field(default_factory=lambda: MappingProxyType({
        '札幌':'01',
        '函館':'02',
        '福島':'03',
        '新潟':'04',
    ...
    RACE_TYPE_DICT: MappingProxyType = dataclasses.field(default_factory=lambda: MappingProxyType({
        '芝': '芝',
        'ダ': 'ダート',
        '障': '障害',
        }))
