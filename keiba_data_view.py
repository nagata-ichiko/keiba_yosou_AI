...
# 各DataFrameをCSV形式で出力
df_results.to_csv(os.path.join(CSV_DIR, 'results.csv'), index=True)
df_return_tables.to_csv(os.path.join(CSV_DIR, 'return_tables.csv'), index=True)
df_horse_results.to_csv(os.path.join(CSV_DIR, 'horse_results.csv'), index=True)
df_peds.to_csv(os.path.join(CSV_DIR, 'peds.csv'), index=True)